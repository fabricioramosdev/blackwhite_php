          ...
          <div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor" id="k_content">
            ...
            <div class="k-content__body	k-grid__item k-grid__item--fluid" id="k_content_body">
              ...
              <div class="row">
													...
													<div class="k-portlet">
														<div class="k-portlet__head">
															<div class="k-portlet__head-label">
																<h3 class="k-portlet__head-title">Adicionar usuário</h3>
															</div>
                            ...
                            <!-- ================================================= -->
                            <form class="k-form k-form--label-right" action="<?php echo base_url() ?>Usuario/post" method="post">
                              <div class="k-portlet__body">
                                <div class="k-section k-section--first">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-lg-9 col-xl-6">
                                        <input class="form-control" type="email" name="email" value="" autocomplete="off" required>
                                      </div>
                                    </div>
                                    <div class="form-group row">
