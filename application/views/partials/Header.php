  ...
  <div class="k-header__topbar">
    ...
    <div class="k-header__topbar-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
        <div class="k-head" style="background-image: url(<?php echo base_url(); ?>assets/media/misc/head_bg_sm.jpg)">
        ...
        <ul class="k-nav k-margin-t-10 k-margin-b-10">
          <li class="k-nav__item k-nav__item--active">
            <a href="#" class="k-nav__link">
              <span class="k-nav__link-icon"><img src="<?php echo base_url(); ?>assets/media/flags/020-flag.svg" alt="" /></span>
              <span class="k-nav__link-text">English</span>
            </a>
          </li>
          <li class="k-nav__item">
            <a href="#" class="k-nav__link">
              <span class="k-nav__link-icon"><img src="<?php echo base_url(); ?>assets/media/flags/016-spain.svg" alt="" /></span>
              <span class="k-nav__link-text">Spanish</span>
            </a>
          </li>
          <li class="k-nav__item">
            <a href="#" class="k-nav__link">
              <span class="k-nav__link-icon"><img src="<?php echo base_url(); ?>assets/media/flags/017-germany.svg" alt="" /></span>
      ...
      <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-md">
        ...
        <ul class="k-nav k-margin-b-10">
          ...
          <li class="k-nav__item k-nav__item--custom k-margin-t-15">
            <a href="<?php echo base_url() ?>LogOut" class="btn btn-outline-metal btn-hover-brand btn-upper btn-font-dark btn-sm btn-bold">Sign Out</a>
          </li>
        </ul>
      </div>
    </div>
