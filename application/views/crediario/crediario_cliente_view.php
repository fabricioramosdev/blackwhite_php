                    ...
                    <div class="k-portlet">
                      ...
                      <div class="k-portlet__body">
                        ...
                        <div class="row" style="margin-bottom:15px">
                          <div class="col-sm-6 col-md-6"><a href="<?php echo base_url(); ?>Crediario/index" class="btn btn-focus btn-wide"><i class="fa fa-undo"></i> Voltar</a></div>
                        </div>
                        <!-- ================================================= -->
                    ...
                    render: function(data, type, full, meta) {
                      ...
                      return `<span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="javascript:;"  onClick="reducao(${full[1]})"><i class="fa fa-chevron-circle-down"></i>Redução dívida</a>
