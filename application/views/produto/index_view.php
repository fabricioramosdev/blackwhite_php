													...
													<div class="k-portlet">
														<div class="k-portlet__head">
															<div class="k-portlet__head-label">
																<h3 class="k-portlet__head-title">Lista de produtos</h3>
															</div>
    					...
    					render: function(data, type, full, meta) {
                            ...
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Produto/edit/${full[0]}"><i class="la la-edit"></i>Editar Produto</a>
                                    <a class="dropdown-item" href="javascript:;"  onClick="deletar(${full[0]},'Produto/delete')"><i class="la la-trash"></i>Deletar Produto</a>
                                </div>
                            </span>
